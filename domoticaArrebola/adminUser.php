    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Bienvenido, <?php print $nombre?> </span>
        ...
        <div class="container-fluid">
          ...
          <hr style="width:450px; margin-right:950px;">
          <pre>
          ...
          <table class="table table-striped">
            <thead>
              <tr>
                 <th scope="col" style="background-color: #4e73df; border:1px solid black; color:white;">Id</th>
                <th scope="col" style="background-color: #4e73df; border:1px solid black; color:white;">Nombre</th>
                <th scope="col" style="background-color: #4e73df; border:1px solid black; color:white;">Apellido</th>
                <th scope="col" style="background-color: #4e73df; border:1px solid black; color:white;">Gmail</th>
                <th scope="col" style="background-color: #4e73df; border:1px solid black; color:white;">Administrador</th>
                <th scope="col" style="background-color: #4e73df; border:1px solid black; color:white;">Controles</th>
              </tr>
            </thead>
            <tbody id="tabla">
